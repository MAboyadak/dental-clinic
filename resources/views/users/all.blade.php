...
<div class="page-content">
    ...
    <div class="card" style="background:white">
        <div class="card-header page-title">
            <h3 class="card-title">{{__('قائمه المستخدمين')}}</h3>
        </div>
                            ...
                            <tr >
                                ...
                                <td>
                                    <form method="POST" action="" style="display:inline-block">
                                        @csrf
                                        <a class="btn btn-xs btn-danger text-white" title="Delete User" onclick=" return ( confirm('هل انت متاكد من المسح') ? window.location.href='{{ route('user.destroy', $user->id) }}' : '' ); ">
