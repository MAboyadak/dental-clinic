...
<div class="modal fade" id="singleEmailModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('prescription.update')}}" method="post" enctype="multipart/form-data">
...
<div class="page-content">
    <div class="card card-info">
        <div class="card-header page-title">
            <h3 class="card-title">{{$patient->name}} {{__('Prescriptions')}}</h3>
        </div>
    </div>
    <div class="card">
        <div class="card-header">
            <a href="{{route('prescriptions.create',$patient->id)}}" class="btn btn-success text-white">{{__('Create Prescription')}}</a>      
        </div>
